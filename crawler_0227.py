...
def crawl(url):
    """
    실제 크롤링 함수
    args : google search API를 통해 받아온 url
    return : 해당 url의 main content
    """   
    ...
    elif fallback_extraction(url):
        return fallback_extraction(url)
    
    # fallback logic (logic3에 해당되는 경우)
...
if __name__ == "__main__":
    ...
    test_urls = [
        ...
        "https://blog.naver.com/syunni1225/222826468342"] # naver blog
